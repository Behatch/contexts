Feature: Testing RESTContext
    ...
    Scenario: Testing request methods.
        ...
        Then The response should contains "You have sent a GET request."
        And The response should contains "No parameter received"

        When I send a GET request to "/rest/index.php?first=foo&second=bar"
        Then The response should contains "You have sent a GET request."
        And The response should contains "2 parameter(s)"
        And The response should contains "first : foo"
        And The response should contains "second : bar"
        ...
        And The response should contains "foofile - name : lorem.txt"
        And The response should contains "foofile - error : 0"
        And The response should contains "foofile - size : 39"

        When I send a PUT request to "/rest/index.php"
        Then The response should contains "You have sent a PUT request."

        When I send a DELETE request to "/rest/index.php"
        Then The response should contains "You have sent a DELETE request."

        When I send a POST request to "/rest/index.php" with body:
            """
            This is a body.
            """
        Then The response should contains "Body : This is a body."
    ...
    Scenario: Add header
        ...
        When I send a GET request to "/rest/index.php"
        Then The response should contains "HTTP_XXX : yyy"
